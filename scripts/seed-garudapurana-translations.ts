/**
 * Seed English translations for Garuda Purana (adhyāyas 4–317) from
 * J.L. Shastri / G.P. Bhatt Tagare-series translation (Motilal Banarsidass).
 *
 * Chapters 1–3 keep curated highlights unless missing or `--force`.
 *
 * Prerequisite: python scripts/extract-garudapurana-tagare.py
 * Run: npm run seed:garudapurana-translations
 */
...
const CACHE_PATH = resolve(ROOT, "scripts/cache/garudapurana-translations.json");
const SOURCE =
  "https://archive.org/details/dli.bengal.10689.20541; https://archive.org/details/dli.bengal.10689.21508; https://archive.org/details/dli.bengal.10689.12942";
...
async function main(): Promise<void> {
  log(`Seeding Garuda Purana from Tagare OCR cache${FORCE ? " [force]" : ""}…`);
  ...
  scripture.source = {
    ...
    translationLicense:
      "J.L. Shastri / G.P. Bhatt translation (Motilal Banarsidass) — 317 GRETIL chapters mapped from 3-part OCR with global-stream fallback.",
