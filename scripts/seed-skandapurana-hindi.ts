/**
 * Seed Hindi for Skanda Purana Revakhanda chapters 5–116 from Gita Press cache.
 *
 * Chapters 1–4 keep curated highlights unless `--force`.
 *
 * Prerequisite: python scripts/extract-skandapurana-hindi.py
 * Run: npm run seed:skandapurana-hindi
 */
...
const CACHE_PATH = resolve(ROOT, "scripts/cache/skandapurana-hindi.json");
...
async function main(): Promise<void> {
  log(`Seeding Skanda Purana Hindi from Gita Press cache${FORCE ? " [force]" : ""}…`);
