/**
 * Seed Hindi for Vayu Purana chapters 4–232 from Sanskrit-Hindi OCR cache.
 *
 * Chapters 1–3 keep curated highlights unless `--force`.
 *
 * Prerequisite: python scripts/extract-vayupurana-hindi.py
 * Run: npm run seed:vayupurana-hindi
 */
...
const CACHE_PATH = resolve(ROOT, "scripts/cache/vayupurana-hindi.json");
...
async function main(): Promise<void> {
  log(`Seeding Vayu Purana Hindi from archive OCR cache${FORCE ? " [force]" : ""}…`);
