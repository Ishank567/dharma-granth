/**
 * Seed Hindi for Linga Purana chapters 4–108 from Gita Press purvabhag cache.
 *
 * Chapters 1–3 keep curated highlights unless `--force`.
 *
 * Prerequisite: python scripts/extract-lingapurana-hindi.py
 * Run: npm run seed:lingapurana-hindi
 */
...
const CACHE_PATH = resolve(ROOT, "scripts/cache/lingapurana-hindi.json");
...
async function main(): Promise<void> {
  log(`Seeding Linga Purana Hindi from Gita Press cache${FORCE ? " [force]" : ""}…`);
