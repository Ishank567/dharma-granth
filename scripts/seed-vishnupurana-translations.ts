/**
 * Seed English translations for Vishnu Purana (adhyāyas 4–126) from
 * M.N. Dutt's prose translation (1896, based on H.H. Wilson).
 *
 * Chapters 1–3 keep curated highlights unless missing or `--force`.
 *
 * Prerequisite: python scripts/extract-vishnupurana-dutt.py
 * Run: npm run seed:vishnupurana-translations
 */
...
const CACHE_PATH = resolve(ROOT, "scripts/cache/vishnupurana-translations.json");
const DUTT_SOURCE = "https://archive.org/details/VishnuPuranaMN_Dutt_1896";
...
async function main(): Promise<void> {
  log(`Seeding Vishnu Purana from Dutt/Wilson OCR cache${FORCE ? " [force]" : ""}…`);
  ...
  scripture.source = {
    ...scripture.source,
    translationRepo: DUTT_SOURCE,
    translationLicense:
      "M.N. Dutt translation (1896), based on H.H. Wilson (1864) — public domain.",
