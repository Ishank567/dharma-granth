/**
 * Seed English translations for Kurma Purana (adhyāyas 4–95) from
 ...
 *
 * Prerequisite: python scripts/extract-kurmapuran-tagare.py
 * Run: npm run seed:kurmapuran-translations
 */
...
const PUB_PATH = resolve(ROOT, "public/data/scriptures-full/kurmapuran.json");
const CACHE_PATH = resolve(ROOT, "scripts/cache/kurmapuran-translations.json");
const SOURCE =
  "https://archive.org/details/kurma-purana-full-vols-20-21";
...
async function main(): Promise<void> {
  log(`Seeding Kurma Purana from Tagare OCR cache${FORCE ? " [force]" : ""}…`);
  ...
  scripture.source = {
    ...
    translationLicense:
      "G.V. Tagare translation (Motilal Banarsidass, UNESCO Indian Series) — scholarly edition.",
