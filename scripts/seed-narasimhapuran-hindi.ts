/**
 * Seed Hindi for Narasimha Purana chapters 5–68 from Gita Press cache.
 *
 * Chapters 1–4 keep curated highlights unless `--force`.
 *
 * Prerequisite: python scripts/extract-narasimhapuran-hindi.py
 * Run: npm run seed:narasimhapuran-hindi
 */
...
const CACHE_PATH = resolve(ROOT, "scripts/cache/narasimhapuran-hindi.json");
...
async function main(): Promise<void> {
  log(`Seeding Narasimha Purana Hindi from Gita Press cache${FORCE ? " [force]" : ""}…`);
