/**
 * Seed English translations for Brahma Purana (adhyāyas 5–246) from
 * G.P. Bhatt / J.L. Shastri Tagare-series translation (Motilal Banarsidass).
 *
 * Chapters 1–4 keep curated highlights unless missing or `--force`.
 *
 * Prerequisite: python scripts/extract-brahmapurana-tagare.py
 * Run: npm run seed:brahmapurana-translations
 */
...
const CACHE_PATH = resolve(ROOT, "scripts/cache/brahmapurana-translations.json");
const SOURCE =
  "https://archive.org/details/dli.bengal.10689.20566; https://archive.org/details/brahma-purana-part-2-ancient-indian-tradition-and-mythology; https://archive.org/details/brahma-purana-part-3-ancient-indian-tradition-and-mythology; https://archive.org/details/dli.bengal.10689.20270";
...
async function main(): Promise<void> {
  log(`Seeding Brahma Purana from Tagare OCR cache${FORCE ? " [force]" : ""}…`);
  ...
  scripture.source = {
    ...
    translationLicense:
      "G.P. Bhatt / J.L. Shastri translation (Motilal Banarsidass) — Tagare 138+Gautami chapters mapped to GRETIL 246 with global-stream fallback.",
