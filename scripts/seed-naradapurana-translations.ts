/**
 * Seed English translations for Narada Purana (adhyāyas 7–167) from
 ...
 *
 * Prerequisite: python scripts/extract-naradapurana-tagare.py
 * Run: npm run seed:naradapurana-translations
 */
...
const CACHE_PATH = resolve(ROOT, "scripts/cache/naradapurana-translations.json");
const SOURCE =
  "https://archive.org/details/dli.bengal.10689.12945; https://archive.org/details/dli.bengal.10689.20659; https://archive.org/details/dli.bengal.10689.21516; https://archive.org/details/the-narada-purana-part-4-ancient-indian-tradition-and-mythology; https://archive.org/details/narada-purana-part-v-ancient-indian-tradition-and-mythology";
...
async function main(): Promise<void> {
  log(`Seeding Narada Purana from Tagare OCR cache${FORCE ? " [force]" : ""}…`);
  ...
  scripture.source = {
    ...
    translationLicense:
      "G.V. Tagare translation (Motilal Banarsidass) — 5-part OCR mapped to GRETIL 167 with global-stream fallback.",
