/**
 * Seed English translations for Agni Purana (adhyāyas 4–381) from
 ...
 *
 * Prerequisite: python scripts/extract-agnipurana-tagare.py
 * Run: npm run seed:agnipurana-translations
 */
...
const PUB_PATH = resolve(ROOT, "public/data/scriptures-full/agnipuran.json");
const CACHE_PATH = resolve(ROOT, "scripts/cache/agnipurana-translations.json");
const SOURCE =
  "https://archive.org/details/agni-purana-part-1-ancient-indian-tradition-and-mythology_20201029; https://archive.org/details/dli.bengal.10689.12912; https://archive.org/details/dli.bengal.10689.12914";
...
async function main(): Promise<void> {
  log(`Seeding Agni Purana from Tagare OCR cache${FORCE ? " [force]" : ""}…`);
  ...
  scripture.source = {
    ...
    translationLicense:
      "G.V. Tagare translation (Motilal Banarsidass) — 311 adhyāyas mapped to GRETIL 381 with global-stream fallback.",
