/**
 * Seed Hindi for Agni Purana chapters 4–381 from Gita Press condensed cache.
 *
 * Chapters 1–3 keep curated highlights unless `--force`.
 *
 * Prerequisite: python scripts/extract-agnipurana-hindi.py
 * Run: npm run seed:agnipurana-hindi
 */
...
const CACHE_PATH = resolve(ROOT, "scripts/cache/agnipurana-hindi.json");
...
async function main(): Promise<void> {
  log(`Seeding Agni Purana Hindi from Gita Press cache${FORCE ? " [force]" : ""}…`);
