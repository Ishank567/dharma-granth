/**
 * Seed Hindi for Vamana Purana chapters 4–95 from Gita Press cache.
 *
 * Chapters 1–3 keep curated highlights unless `--force`.
 *
 * Prerequisite: python scripts/extract-vamanpuran-hindi.py
 * Run: npm run seed:vamanpuran-hindi
 */
...
const CACHE_PATH = resolve(ROOT, "scripts/cache/vamanpuran-hindi.json");
...
async function main(): Promise<void> {
  log(`Seeding Vamana Purana Hindi from Gita Press cache${FORCE ? " [force]" : ""}…`);
