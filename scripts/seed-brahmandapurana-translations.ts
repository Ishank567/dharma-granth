/**
 * Seed English translations for Brahmanda Purana (adhyāyas 4–156) from
 ...
 *
 * Prerequisite: python scripts/extract-brahmandapurana-tagare.py
 * Run: npm run seed:brahmandapurana-translations
 */
...
const CACHE_PATH = resolve(ROOT, "scripts/cache/brahmandapurana-translations.json");
const SOURCE =
  "https://archive.org/details/dli.bengal.10689.21603; https://archive.org/details/dli.bengal.10689.16203; https://archive.org/details/dli.bengal.10689.12922; https://archive.org/details/BrahmandaPuranaG.V.TagarePart4; https://archive.org/details/BrahmandaPuranaG.V.TagarePart5";
...
async function main(): Promise<void> {
  log(`Seeding Brahmanda Purana from Tagare OCR cache${FORCE ? " [force]" : ""}…`);
  ...
  scripture.source = {
    ...
    translationLicense:
      "G.V. Tagare translation (Motilal Banarsidass) — 5-part OCR mapped to GRETIL 156 with global-stream fallback.",
