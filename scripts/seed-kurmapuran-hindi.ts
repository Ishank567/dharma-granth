/**
 * Seed Hindi for Kurma Purana chapters 4–95 from Gita Press cache.
 *
 * Chapters 1–3 keep curated highlights unless `--force`.
 *
 * Prerequisite: python scripts/extract-kurmapuran-hindi.py
 * Run: npm run seed:kurmapuran-hindi
 */
...
const CACHE_PATH = resolve(ROOT, "scripts/cache/kurmapuran-hindi.json");
...
async function main(): Promise<void> {
  log(`Seeding Kurma Purana Hindi from Gita Press cache${FORCE ? " [force]" : ""}…`);
