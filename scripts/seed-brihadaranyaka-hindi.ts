/**
 * Seed Hindi for Brihadaranyaka Upanishad from Gita Press Shankara-bhashya Hindi tika
 * (archive.org RUgF_brihadaranyaka-upanishad-577-gita-press-gorakhpur).
 *
 * Prerequisite: python scripts/extract-brihadaranyaka-hindi.py
 * Run: npm run seed:brihadaranyaka-hindi
 */
...
const CACHE_PATH = resolve(ROOT, "scripts/cache/brihadaranyaka-hindi.json");
...
async function main(): Promise<void> {
  log(`Seeding Brihadaranyaka Hindi from Gita Press cache${FORCE ? " [force]" : ""}…`);
